if (window.matchMedia("(max-width: 768px)").matches) {
  function OpenOnClick1() {
    let x = document.getElementById(
      document.getElementsByClassName("content-to-show")[0].id
    );
  ...
  function OpenOnClick2() {
    let x = document.getElementById(
      document.getElementsByClassName("content-to-show")[1].id
    );
  ...
  function OpenOnClick3() {
    let x = document.getElementById(
      document.getElementsByClassName("content-to-show")[2].id
    );
  ...
  function OpenOnClick4() {
    let x = document.getElementById(
      document.getElementsByClassName("content-to-show")[3].id
    );
  ...
  function OpenOnClick5() {
    let x = document.getElementById(
      document.getElementsByClassName("content-to-show")[4].id
    );
